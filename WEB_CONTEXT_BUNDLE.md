...
```json
{
  ...
  "attempts": [
    {
      "artifacts": [],
      "attempt_id": "attempt:um-ep-125-erd-s-problem-125-77ad6bf6-source-fidelity-01",
      "claims": [],
      "completed_at": null,
      "generator": "trusted-rolling-source-admission-v1",
      "inputs": [
        "problem-library/records/canonical-problems.jsonl",
        "https://www.unsolvedmath.com/problems/EP-125"
      ],
      "lifecycle": "planned",
      "method": "discovery",
      "objective": "Close the source-fidelity obligation before attempting the frozen root statement.",
      "obligation_graph_id": "graph:um-ep-125-erd-s-problem-125-77ad6bf6-v1",
      "problem_contract_sha256": "c3d16097646832dfa878d1805873ddac398272694db13beab8ab9e37f4eb52cd",
      "problem_id": "problem:um-ep-125-erd-s-problem-125-77ad6bf6",
      "route_id": "route:um-ep-125-erd-s-problem-125-77ad6bf6-source-fidelity",
  ...
  "obligation_graphs": [
    {
      "attempt_id": "attempt:um-ep-125-erd-s-problem-125-77ad6bf6-source-fidelity-01",
      "graph_id": "graph:um-ep-125-erd-s-problem-125-77ad6bf6-v1",
      "obligations": [
        {
          "dependencies": [
            "obligation:um-ep-125-erd-s-problem-125-77ad6bf6-statement-fidelity"
          ],
          "kind": "root_claim",
          "obligation_id": "obligation:um-ep-125-erd-s-problem-125-77ad6bf6-root",
          "statement": {
            "formal_declaration": null,
            "language": "en",
            "text": "Let $A = \\{ \\sum\\epsilon_k3^k : \\epsilon_k\\in \\{0,1\\}\\}$ be the set of integers which have only the digits $0,1$ when written base $3$, and $B=\\{ \\sum\\epsilon_k4^k : \\epsilon_k\\in \\{0,1\\}\\}$ be the set of integers which have only the digits $0,1$ when written base $4$. Does $A+B$ have positive density?"
          },
          "statement_sha256": "a00b87de7f58762f739bac6ef42e40dc3fe8ed6f04ff99d437116cc449e75e9d"
        },
        {
          "dependencies": [],
          "kind": "definition",
          "obligation_id": "obligation:um-ep-125-erd-s-problem-125-77ad6bf6-statement-fidelity",
          "statement": {
            "formal_declaration": null,
            "language": "en",
      ...
      "root_obligation_id": "obligation:um-ep-125-erd-s-problem-125-77ad6bf6-root",
      "route_id": "route:um-ep-125-erd-s-problem-125-77ad6bf6-source-fidelity"
    }
  ],
  "problem_contract": {
    ...
    "sources": [
      {
        ...
        "source_record_id": "unsolvedmath-ep-125-38620c0fe966",
        "url": "https://www.unsolvedmath.com/problems/EP-125"
      },
      {
        "retrieved_at": "2026-09-02T00:06:43Z",
